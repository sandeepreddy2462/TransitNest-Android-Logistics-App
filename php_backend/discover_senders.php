...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
  ...
  $sql = "SELECT u.username, u.useremail, u.userphonenumber, t.content, t.weight_kgs,t.receiver_mobile, t.receiver_email, t.receiver_name FROM senders_details t JOIN users u ON t.useremail = u.useremail WHERE t.sender_address = ? AND t.receiver_address = ?";
